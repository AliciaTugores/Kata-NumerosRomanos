...
public class NumeroRomano {
    ...
    private RegexNumeroRomanos regexDiccionario = new RegexNumeroRomanos();
    ...
    public void setRegexDiccionario(RegexNumeroRomanos regex){
        this.regexDiccionario = regex;
    }

    public RegexNumeroRomanos getRegexDiccionario() {
